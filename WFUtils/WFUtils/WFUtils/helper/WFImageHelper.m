...
+ (UIImage *)circleImageWithName:(UIImage *)srcImage borderWidth:(CGFloat)borderWidth borderColor:(UIColor *)borderColor
{
    ...
    // 2.开启上下文
    CGFloat imageW = srcImage.size.width + 2 * borderWidth;
    CGFloat imageH = srcImage.size.height + 2 * borderWidth;
    ...
    // 6.画图
    [srcImage drawInRect:CGRectMake(borderWidth, borderWidth, srcImage.size.width, srcImage.size.height)];
